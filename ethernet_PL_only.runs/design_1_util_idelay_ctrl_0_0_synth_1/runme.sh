...
HD_PWD='C:/Users/vieira/Downloads/PortableGit/ethernet_PL_only/ethernet_PL_only.runs/design_1_util_idelay_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_util_idelay_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_util_idelay_ctrl_0_0.tcl
